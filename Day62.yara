...
rule Actor_UNC4393_MAL_Dropper_DAWNCRY_PEProperties_FEB25
{
  meta:
    author = "RustyNoob619"
    description = "Detects DAWNCRY which is a memory-only dropper that decrypts an embedded resource into memory"
